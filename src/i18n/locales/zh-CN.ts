...
export const zhCN: Dict = {
  ...
  'common.exportPng': '导出为 PNG 图片',
  'common.exportPngBusy': '正在生成 PNG…',
  'common.justNow': '刚刚',
  ...
  'newproj.directionTitle': '或选一个视觉方向（无品牌时使用）',
  'newproj.directionTitleDsActive': '或用视觉方向代替品牌设定',
  'newproj.directionSelected': '方向 · {label}',
  'newproj.directionClear': '清除方向',
  ...
  'fileViewer.exportPng': '导出为 PNG 图片',
