...
export const en: Dict = {
  ...
  'common.exportPng': 'Export as PNG image',
  'common.exportPngBusy': 'Rendering PNG…',
  ...
  'newproj.directionTitle': 'Or pick a visual direction (no brand)',
  'newproj.directionTitleDsActive': 'Or replace the brand with a visual direction',
  'newproj.directionSelected': 'Direction · {label}',
  'newproj.directionClear': 'Clear direction',
  ...
  'examples.exportPng': 'Export as PNG image',
  ...
  'fileViewer.exportPng': 'Export as PNG image',
